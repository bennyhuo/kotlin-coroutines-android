...
interface RecyclerViewScoped: BasicScoped {
    ...
    class __RecyclerView_OnChildAttachStateChangeListener(private val mainScope: MainScope) : android.support.v7.widget.RecyclerView.OnChildAttachStateChangeListener {
    ...
    class __RecyclerView_OnItemTouchListener(private val mainScope: MainScope) : android.support.v7.widget.RecyclerView.OnItemTouchListener {

        private var _onInterceptTouchEvent: (suspend MainScope.(android.support.v7.widget.RecyclerView, android.view.MotionEvent) -> Boolean)? = null
        ...
        fun onInterceptTouchEvent(
                ...
                listener: suspend MainScope.(android.support.v7.widget.RecyclerView, android.view.MotionEvent) -> Boolean
        ) {
            _onInterceptTouchEvent = listener
            _onInterceptTouchEvent_returnValue = returnValue
        }

        private var _onTouchEvent: (suspend MainScope.(android.support.v7.widget.RecyclerView, android.view.MotionEvent) -> Unit)? = null
        ...
        fun onTouchEvent(
                listener: suspend MainScope.(android.support.v7.widget.RecyclerView, android.view.MotionEvent) -> Unit
        ) {
